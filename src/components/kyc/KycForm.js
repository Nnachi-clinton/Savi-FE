...
const KycForm = () => {
    ...
    const handleChange = (event) => {
        ...
        if (files) {
            ...
            const updatedValue =
                name === 'gender' || name === 'occupation' || name === 'identificationType'
                    ? parseInt(value, 10)
                    : value;
            ...
            <form onSubmit={handleSubmit}>
                <fieldset>
                        ...
                        <FormRow>
                            <div>
                                ...
                                <Select
                                    ...
                                    onBlur={(e) => e.target.style.color = e.target.value === '' ? '#D0D5DD' : '#000'}
                                >
                    ...
                    <FormRowb>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <React.Fragment>
                                        <Section>Drop your files here or <Span>browse</Span></Section>
                                        <input
                                            type="file"
                                            onChange={(e) => handleChange(e, 'identificationDocument')}
                        ...
                        <Button
                            type="submit"
                            disabled={!getIsFormValid(formData)}
                        >
                            Submit
                        </Button>
                    </FormRowb>

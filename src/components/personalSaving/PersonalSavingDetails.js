        ...
        <ParentContainer>
            <Details>
                <DetailColumn>
                    ...
                    <Heading><span>&#8358;</span>{amountSaved}</Heading>
                </DetailColumn>
                <DetailColumn>
                    <DetailText>Total Target</DetailText>
                    <Heading><span>&#8358;</span>{totalTarget}</Heading>
                </DetailColumn>
                <DetailColumn>
                    <DetailText>Days left</DetailText>
                    <Heading>{daysLeft} {renderDaysText()}</Heading>
                </DetailColumn>
            </Details>
            <ButtonParent>
            ...
            {isWithdrawModalVisible && <WithdrawFunds onClose={handleCloseWithdrawModal} />}
        </ParentContainer>
    );
}

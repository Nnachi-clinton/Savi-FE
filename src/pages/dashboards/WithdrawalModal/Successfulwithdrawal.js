...
function Successfulwithdrawal(props) {
  return (
    <Main>
      <InnerWrapper>
        <div>
        ...
        <DivM>
          ...
          <Div>Successful!</Div>
          <Div1>
            A sum of ₦50,000 has been withdrawn from your wallet, <br/>your remaining wallet balance is ₦200,000
            </Div1>
        </DivM>
      </InnerWrapper>
    </Main>
...
export default Successfulwithdrawal;
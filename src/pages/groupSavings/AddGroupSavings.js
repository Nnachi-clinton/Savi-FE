...
const Document = styled.label`
    ...
    .fileName { /* Style for the file name */
        position: absolute;
        top: 50%;
        left: 50%;
...
const AddGroupSavings = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            axios.post('https://localhost:7240/api/GroupSavings/CreateGroupSavings', 
            requestData,
            {
                headers: {
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <React.Fragment>
                                            ...
                                            <Section>Drop your image here or <Span>browse</Span></Section>
                                            <input
                                                type="file"
